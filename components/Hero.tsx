  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#0a0a0a] pt-20">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="hero-glow hero-glow-lime absolute right-[-15%] top-[5%] h-[500px] w-[500px] rounded-full bg-[#c7ff3d]/10" />

        <div className="hero-glow hero-glow-purple absolute bottom-[-15%] left-[-10%] h-[450px] w-[450px] rounded-full bg-purple-500/10" />
      </div>
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-80px)] max-w-7xl flex-col justify-center px-5 py-20 sm:px-6 lg:px-8">
        ...
        {/* SCROLL */}
        <div className="absolute bottom-8 right-6 hidden items-center gap-3 text-xs uppercase tracking-widest text-white/30 lg:flex">
          <span>Scroll</span>
